...
alter table public.cncvault_roles disable row level security;
...
alter table public.cncvault_profiles disable row level security;
...
alter table public.cncvault_user_roles disable row level security;
...
alter table public.cncvault_parties disable row level security;
...
alter table public.cncvault_parts disable row level security;
...
alter table public.cncvault_documents disable row level security;
...
alter table public.cncvault_document_versions disable row level security;
...
alter table public.cncvault_document_permissions disable row level security;
...
alter table public.cncvault_audit_logs disable row level security;
...
alter table public.cncvault_notifications disable row level security;
...
-- Enable RLS
ALTER TABLE public.cncvault_party_drives disable row level security;
