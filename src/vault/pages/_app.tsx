import { createFileRoute, Outlet, useNavigate, Link } from "@/vault/router-adapter";
...
import { Sheet, SheetContent, SheetTrigger } from "@/vault/components/ui/sheet";
import { Avatar, AvatarFallback, AvatarImage } from "@/vault/components/ui/avatar";
