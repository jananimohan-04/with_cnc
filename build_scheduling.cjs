...
const dir = path.join('src', 'pages', 'production', 'unified');
if (!fs.existsSync(dir)) fs.mkdirSync(dir, { recursive: true });
fs.writeFileSync(path.join(dir, 'SchedulingPage.tsx'), code);

// Now update App.tsx to point to this new unified page
let app = fs.readFileSync('src/App.tsx', 'utf8');

// Replace MachineSchedulingPage import
app = app.replace(
  /MachineSchedulingPage,?\s*/,
  ''
);

// Add import for new SchedulingPage
app = app.replace(
